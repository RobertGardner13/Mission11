...
const AdminBooksPage = () => {
    ...
    const handleDelete = async (bookId: number) => {
        ...
        try {
            await deleteBook(bookId);  // Call the deleteBook function from the API
            setBooks(books.filter((b) => b.bookID !== bookId)); // Update the state by removing the deleted book
        } catch (error) {
...
function deleteProject(bookId: number) {
